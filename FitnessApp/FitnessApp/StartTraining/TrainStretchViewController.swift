...
class TrainStretchViewController: UIViewController, AVSpeechSynthesizerDelegate {
    
    var exercises: [Stretch] = []
    ...
    private func loadExercises() {
        ...
        do {
            ...
            let decodedData = try decoder.decode([String: [Stretch]].self, from: data)
    ...
    private func startExercise() {
        ...
        repetitionsLabel.frame = CGRect(x: 20, y: containerView.frame.maxY + 20, width: view.bounds.width - 40, height: 40)
        repetitionsLabel.textAlignment = .center
        repetitionsLabel.textColor = .black
        repetitionsLabel.font = UIFont.systemFont(ofSize: 24)
        repetitionsLabel.tag = 999
