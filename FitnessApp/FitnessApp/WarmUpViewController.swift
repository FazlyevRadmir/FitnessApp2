...
class WarmUpViewController: UIViewController, UIGestureRecognizerDelegate {

    var exercises: [ExerciseWarmUp] = []
    ...
    @objc private func startButtonTapped() {
        let exerciseScreenViewController = TrainWarmupViewController()
    ...
    private func loadExercises() {
        ...
        do {
            ...
            exercises = try decoder.decode([String: [ExerciseWarmUp]].self, from: data)["exercises"] ?? []
    ...
    private func showExerciseDetails(_ exercise: ExerciseWarmUp) {
        let modalViewController = WarmUpDetailViewController()
